...
def run_confidence_experiment(confidence_value):
    ...
    os.makedirs("results/h36m", exist_ok=True)
...
def create_summary():
    ...
    with open("results/h36m/summary.txt", "w") as summary:
        ...
        for conf in confidence_values:
            filename = f"results/h36m/confidence_{conf}.txt"
    ...
    print("Summary created: results/h36m/summary.txt")
...
def main():
    ...
    create_summary()
    print("Check results/h36m directory for all outputs!")
